...
object ExampleString {
    ...
    /**declare a variable*/ var number= (-100);
    
    if(number==0){ println("number is zero");
    }
    else if(number>0){
    ...
    object ExPrintName {
    def main(args: Array[String]) { println("My name is Mike!")
    }
    }
    ...
    def main(args: Array[String]) { var number1=20;
    var number2=30; var x = 10;
